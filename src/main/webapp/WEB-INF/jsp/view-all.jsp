...
<a class="btn btn-default" href="view-all.jsp">Все&nbsp;&#40;${UncommitedSum}&#41;</a>
</c:if>

<c:if test="${section==null}">
<a class="btn btn-selected" href="view-all.jsp">Все&nbsp;&#40;${UncommitedSum}&#41;</a>
</c:if>

<c:if test="${section.id != 1}">
<a class="btn btn-default" href="view-all.jsp?section=1">Новости&nbsp;&#40;${UncommitedNewsCount}&#41;</a>
</c:if>

<c:if test="${section.id == 1}">
<a class="btn btn-selected" href="view-all.jsp?section=1">Новости&nbsp;&#40;${UncommitedNewsCount}&#41;</a>
</c:if>

<c:if test="${section.id != 3}">
<a class="btn btn-default" href="view-all.jsp?section=3">Галерея&nbsp;&#40;${UncommitedGalleryCount}&#41;</a>
</c:if>

<c:if test="${section.id == 3}">
<a class="btn btn-selected" href="view-all.jsp?section=3">Галерея&nbsp;&#40;${UncommitedGalleryCount}&#41;</a>
</c:if>

<c:if test="${section.id != 5}">
<a class="btn btn-default" href="view-all.jsp?section=5">Голосования&nbsp;&#40;${UncommitedPollsCount}&#41;</a>
</c:if>
