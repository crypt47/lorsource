...
~    distributed under the License is distributed on an "AS IS" BASIS,
    ...
    <div class="help-block">Ctrl-Enter отправить комментарий</div>
    <div class="help-block"><b>Картинки</b>: в markdown: ![](http://url.com/img.png)<br>

    Описание разметки <a target="_blank" href="/help/markdown.md">Markdown</a> или 
    <a href="/help/lorcode.md" target="_blank" title="
    ...
    [user]username[/user] - ссылка на профиль пользователя. 
