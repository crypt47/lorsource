...
Мы используем популярную разметку [Markdown](https://en.wikipedia.org/wiki/Markdown).

## Картинки

```
![](https://url/picture.png)
```
...
`@user` дает ссылку на профиль пользователя сайта.  При использовании этого тега упомянутому пользователю приходит 
уведомление.
